...
import {RouteMap, RoutesCarousel, RoutesItinerary, RouteTitle,} from "../../components";
...
export class ShowRoute extends Component {
	...
	render() {
		return (
			(this.state.promiseIsResolved) ? <div>
				<Row>
					<Col xs={12} md={2}/>
			...
			</div> : <h1 style={{textAlign: "center"}}>CÓMEME ESTA LABRAAAA</h1>
		);
	}
}