                ...
                <Row>
                    ...
                    <Col xs={12} md={8} className="profile-card">
                        <Card className="text-center">
                            <Card.Header>
                                <Image src="/img/profile/user.png" className="profile-img"/>
                                <Value src={`[${activeProfile}].name`}/>
                            </Card.Header>
                            <Card.Body>
                                <Card.Title>
                                    <Image src="/img/Solid.svg" className="profile-img"/>
                                    <a href={profileInput}>
                                        {profileInput}
                                    </a>
                                </Card.Title>
                                ...
                                <Card.Text>
                                    <Link to="/myRoutes">
                                        <Image src="/img/home/keepyours.svg" className="profile-img"/>
                                        <h2>My routes</h2>
                                    </Link>
                                </Card.Text>
                            </Card.Body>
