...
import {
	Home, Friends, Profile, Register, NotFound, MyRoutes, FriendsRoutes, RoutesList, ShowRoute
} from "./containers";
		...
		<Router>
			<Fragment>
				...
				<Switch>
					...
					<PrivateLayout component={MyRoutes} path="/myRoutes" exact/> {/* MyRoutes - "/myRoutes" */}
					<PrivateLayout component={FriendsRoutes} path="/friendsRoutes"
								   exact/> {/* FriendsRoutes - "/friendsRoutes" */}
					<PrivateLayout component={RoutesList} path="/routesList" exact/> {/* RoutesList - "/routesList" */}
